            ...
            while (runProgram)
            {
                ...
                switch (selection)
                {
                    ...
                    case ("Show all unassigned chores"):
                        ...
                        Console.WriteLine("These chores have not been assigned a roommate:");
                    ...
                    case ("Search for roommate"):
                        ...
                        Console.WriteLine($"{roommate.FirstName} - Rent Portion: {roommate.RentPortion}, Occupancy: {roommate.Room.Name}");
